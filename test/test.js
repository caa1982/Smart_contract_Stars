...
contract('Mintable', accounts => {
  ...
  it("Should be able to mint one Planet and another account should be able to buy it", async () => {
    ...
    await contractMintable.buyTokens([98846], [1000000000000000000], {from: account2, value: deployDetails.initPrice[1]});
    contractERC721.ownerOf(98846).then(_owner => {
        assert.equal(_owner, account2, "it should have created a planet token");
    })
  });
